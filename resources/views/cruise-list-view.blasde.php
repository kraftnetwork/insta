...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title> GoInstaTrip - Dubai Most Reliable Tourist Company. Visa Change | UAE Visa | Global Visa | </title>
    <!-- Favicon -->
...
<body>
   ...
   <!-- Navigation Bar -->
                ...
                <div class="header_menu">
                    ...
                    <nav class="navbar navbar-default navbar-sticky-function navbar-arrow">
                        <div class="logo pull-left">
                            <a href="/"><img alt="Image" src="images/goinstatrip-logo.png" style="    width: 200px;margin-top: 4px;margin-right: 45px;"></a>
                        </div>
                        <div id="navbar" class="navbar-nav-wrapper">
                            <ul class="nav navbar-nav" id="responsive-menu">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li> <a href="dubai-georgia">Dubai to Georgia </a></li>
                                        <li><a href="india-dubai">India to Dubai</a></li>
    ...
    <section class="breadcrumb-outer text-center">
        <div class="container">
            <div class="breadcrumb-content">
                <h2>Cruises</h2>
                <h4 class="white">We Found: 38 Itineraries (Starting From $36.78/person)</h4>
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Cruises Grid View</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <!-- Destinations -->
    <section class="cruise-destinations">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <div class="cruise-head">
                        <div class="cruise-sort pull-left">
                            ...
                            <div class="form-group">
                                <select name="custom-select-1" class="selectpicker form-control" tabindex="1">
                                    ...
                                    <option value="1">A-H</option>
                                    <option value="2">I-Z</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <select name="custom-select-1" class="selectpicker form-control" tabindex="1">
                        ...
                        <div class="click-menu pull-right">
                            <span>View:</span>
                            <div class="change-list f-active"><a href="cruise-list-view.html"><i class="fa fa-bars"></i></a></div>
                            <div class="change-grid"><a href="cruise-grid-view.html"><i class="fa fa-th"></i></a></div>
                        </div>
                    </div>
                    <div class="blog-wrapper">                            
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise1.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                                        <h5><strong class="color-red-3">$36.00</strong> / Person</h5>
                                        <h6>From: Miami, FL</h6>
                                        <h3><a href="cruise-detail.html">7 Night Western Caribbean</a></h3>
                                        <p>Abroad: Carnival Ecstasy</p>
                                        <p>Sails to: Key West, FL; Cozumel, Mexico</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="blog-item grid-item">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise2.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                        ...
                        <div class="blog-item grid-item">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise3.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                        ...
                        <div class="blog-item grid-item">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise4.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                        ...
                        <div class="blog-item grid-item">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise5.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                        ...
                        <div class="blog-item grid-item">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise6.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                        ...
                        <div class="blog-item grid-item">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise7.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                        ...
                        <div class="blog-item grid-item">
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="blog-image">
                                        <img src="images/cruise/cruise8.jpg" alt="Image">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-xs-12">
                                    <div class="destination-content">
                        ...
                        <div class="sidebar-item sidebar-item-dark">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <select name="custom-select-3" class="selectpicker form-control" tabindex="1">
                                          <option>Travllers</option>
                                          <option>1</option>
                                          <option>2</option>
                                          <option>3</option>
                                          <option>4</option>
...
<!-- Mirrored from cyclonethemes.com/demo/html/yatra/cruise-list-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Feb 2020 08:50:38 GMT -->
</html>